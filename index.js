...
//
const BotName = 'Diky Bot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/diky_hs19'; // Nama Instagramlu cok
const whatsapplu = '0813-2665-8967'; // Nomor whatsapplu cok
const kapanbotaktif = 'Bar Muleh Sekolah'; // Kapan bot lu aktif
const grupch1 = 'Durong ono'; // OFFICIAL GRUP LU 1
const grupch2 = 'Durong ono'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
